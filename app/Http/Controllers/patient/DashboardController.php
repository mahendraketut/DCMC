...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('patient.dashboard', compact('appointment', 'schedule', 'doctor', 'appointmentCount', 'appointment_patient', 'specialist'));
    }
    ...
    public function filter(Request $request)
    {
        ...
        $appointment_patient = Appointment::where('patient_id', '=', Auth::user()->id)->get();
        $appointmentCount = Appointment::where('patient_id', '=', Auth::user()->id)->where('status', '=', 'Pending')->orWhere('status', '=', 'Approved')->orWhere('status', '=', 'Waiting Call')->orWhere('status', '=', 'Under Examination')->orWhere('status', '=', 'Waiting Payment')->count();
        return view('patient.dashboard', compact('schedule', 'doctor', 'appointment_patient', 'specialist', 'appointmentCount'));
    }
