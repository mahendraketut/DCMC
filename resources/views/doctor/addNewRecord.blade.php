    ...
    <div class="col-xl-12">
        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            <div class="card-header pt-8">
                <div class="card-title">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Add New Record for
            ...
            <div class="card-body pt-5 pb-3">
                @if (
                    $appointment->patient->username == null ||
                        ...
                        <div class="d-flex flex-column pe-0 pe-sm-10">
                            ...
                            <span>
                                @if ($appointment->patient->gender == 'Male')
                                    We found that Mr {{ $appointment->patient->name }} is not completing his account
                                    profile. Please ask him to complete his profile to get better experience. Thank you.
                                @elseif ($appointment->patient->gender == 'Female')
                                    We found that Mrs {{ $appointment->patient->name }} is not completing her account
                                    profile. Please ask her to complete her profile to get better experience. Thank you.
                                @else
                                    We found that your patient is not completing his/her account profile. Please ask him/her
                                    to complete his/her profile to get better experience. Thank you.
                                @endif
                            </span>
                        </div>
                        <!--end::Content-->
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="kt_accordion_1_body_1" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="col md-12">
                                    <input type="text" class="form-control" value="{{ $appointment->appointment_id }}"
                                        disabled>
                                </div>
                                <label class="col col-col col-form-label fw-bold fs-6 fw-bold fs-6">Appointment Time</label>
                                <div class="col md-12">
                                    <input type="text" class="form-control" value="{{ $appointment->appointment_time }}"
                                        disabled>
                                </div>
                                <label class="col col-col col-form-label fw-bold fs-6 fw-bold fs-6">Appointment
                                    Status</label>
                                <div class="col md-12">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="kt_accordion_1_body_2" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col md-6">
                                        <label class="col col-col col-form-label fw-bold fs-6 fw-bold fs-6">Patient
                                            ID</label>
                                        <div class="col md-12">
                                            <input type="text" class="form-control"
                                                value="{{ $appointment->patient->user_id }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col md-6">
                                        <label class="col col-col col-form-label fw-bold fs-6 fw-bold fs-6">Patient
                                        ...
                                        <div class="col md-12">
                                            <input type="text" class="form-control"
                                                value="{{ $appointment->patient->name }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col md-6">
                                        ...
                                        <div class="col md-12">
                                            <input type="text" class="form-control"
                                                value="{{ $appointment->patient->gender }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col md-6">
                                        <label class="col col-col col-form-label fw-bold fs-6 fw-bold fs-6">Patient
                                ...
                                <div class="row g-3">
                                    <div class="col md-6">
                                        ...
                                        <div class="col md-12">
                                            <input type="text" class="form-control"
                                                value="{{ $appointment->patient->email }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col md-6">
                                        <label class="col col-col col-form-label fw-bold fs-6 fw-bold fs-6">Patient
                                        ...
                                        <div class="col md-12">
                                            ...
                                            @else
                                                <input type="text" class="form-control"
                                                    value="{{ $appointment->patient->phone }}" disabled>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col md-8">
                                        ...
                                        <div class="col md-12">
                                            ...
                                            @else
                                                <input type="text" class="form-control"
                                                    value="{{ $appointment->patient->address }}" disabled>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col md-4">
                                        ...
                                        <div class="col md-12">
                                            ...
                                            @else
                                                <input type="text" class="form-control"
                                                    value="{{ $appointment->patient->city }}" disabled>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($medicalrecords as $medicalrecord)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/doctor.medicalrecord.edit/' . Crypt::encrypt($medicalrecord->id)) }}"
                                                            class="btn btn-sm btn-light btn-active-success me-2"
                                                            alt="Make Medical Record Data">
                        ...
                        <div id="kt_accordion_1_body_4" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <form method="POST" action="{{ route('doctor.medicalrecordBook.saverecord') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <select class="form-select" name="medical_category" id="medical_category"
                                                required>
                                                <option value="">Choose one...</option>
                                                @foreach ($medicalCategories as $medicalcategory)
                                                    <option value="{{ $medicalcategory->id }}">
                                                        {{ $medicalcategory->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#addMedicalCategoryModal">
                                ...
                                <form method="POST" action="{{ route('doctor.medicalrecordBook.transactionAdd') }}">
                                    {{ csrf_field() }}
                                    <!--begin:card body-->
                                    <input type="hidden" name="appointment_id" value="{{ $appointment->id }}">
                                    <label class="col col-form-label fw-bold fs-6">Service</label>
                                    ...
                                    <label class="col col-form-label fw-bold fs-6">Notes</label>
                                    <textarea class="form-control" name="notes" id="notes" rows="6" maxlength="255"></textarea>
                                                ...
                                                @foreach ($prescription as $prescription)
                                                    <tr>
                                                        ...
                                                        @if ($prescription->status == 'New')
                                                            <td>
                                                                <a href="{{ url('/doctor.medicalrecord.addRecord.request/' . $prescription->id) }}"
                                                                    class="btn btn-primary" alt="Request Prescription">
                                                                    <i class="fas fa-file-medical-alt"></i>
                                                                    Request
                                                                </a>
                                                                {{-- <a href="{{url('/doctor.medicalrecord.edit/'.$medicalrecord->id)}}" class="btn btn-sm btn-light btn-active-success me-2" alt="Make Medical Record Data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <select id="medicine" name="medicine"
                                                class="form-select form-select-solid form-select-lg fw-bold form-control @error('medicine') is-invalid @enderror">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="number_medicine"
                                                id="number_medicine" required
                                                placeholder="number of medicines prescribed ">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="col col-form-label fw-bold fs-6">Dosage</label>
                                            <input type="text" class="form-control" name="dosage" id="dosage"
                                                required placeholder="dosage of the medicines">
                                        </div>
                                        <div class="col-md-1">
