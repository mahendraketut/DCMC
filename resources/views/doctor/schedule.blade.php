    ...
    <div class="card card-xl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
                <a href="{{route('doctor.schedule.add')}}" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#modal_add_schedule">
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td class="ps-4 min-w-20px text-center">
                                    <a href="{{url('/doctor.dashboard/schedule.edit/'.$schedule->id)}}" class="btn btn-primary">Edit</a> |
                                    <a href="{{url('/doctor.dashboard/schedule.delete/'.$schedule->id)}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        @endif
