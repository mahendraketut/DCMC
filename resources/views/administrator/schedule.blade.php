        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                    ...
                    <a href="{{ route('admin.schedule.add') }}" class="btn btn-sm btn-light btn-active-primary"
                                ...
                                @foreach ($schedule as $schedule)
                                    <tr>
                                        ...
                                        <td class="ps-4 min-w-20px text-center">
                                            <a href="{{ url('/admin.dashboard/schedule.edit/' . Crypt::encrypt($schedule->id)) }}"
                                                class="btn btn-primary">Edit</a>
                                            <a href="{{ url('/admin.dashboard/schedule.delete/' . Crypt::encrypt($schedule->id)) }}"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form class="form" id="modal_add_schedule_form" action="{{ route('admin.schedule.store') }}"
                        method="POST">
                        @csrf
                        <!--begin::Input group-->
                        <!--begin::Label-->
                        <div class="fv-row mb-10">
                            ...
                            <div class="col fv-row">
                                <select id="doctor_name" name="doctor_name"
                                    class="form-select form-select-solid form-select-lg fw-bold form-control @error('doctor_name') is-invalid @enderror">
