        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                    title="Click to add a new specialist category">
                    <a href="{{ route('admin.specialist.add') }}" class="btn btn-sm btn-light btn-active-primary"
                                ...
                                @foreach ($specialists as $specialist)
                                    <tr>
                                        ...
                                        <td class="ps-4 min-w-50px text-center">
                                            {{ $specialist->doctors ? $specialist->doctors->count() : 0 }}</td>
                                        <td class="ps-4 min-w-20px text-center">
                                            ...
                                            <a href="{{ url('/admin.specialist.edit/' . Crypt::encrypt($specialist->id)) }}"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form class="form" id="modal_add_schedule_form" action="{{ route('admin.specialist.store') }}"
                        method="POST">
                        @csrf
                        <!--begin::Input group-->
                        <!--begin::Label-->
                        ...
                        <div class="col-lg-12 fv-row">
                            <input type="text"
                                class="form-control form-control-lg form-control-solid form-control @error('name') is-invalid @enderror"
