                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('admin.dashboard') }}"
                                    title="Go to your dashboard menu" data-bs-toggle="tooltip" data-bs-trigger="hover"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">Register Accounts</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('register_doctor') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Register Doctor</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ Route('register_pharmacist') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Register Pharmacist</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('admin.proposed') }}">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('admin.appointment') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <span class="menu-title">Patient Appointment</span>
                                </a>
                            </div>
                            ...
                            <div class="menu-item">
                                <div class="menu-content pt-8 pb-2">
                                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">PAYMENT</span>
                                </div>
                            </div>
                            <div class="menu-item">
                            ...
                            <!--END: PAYMENT AREA-->
                                ...
                                <div class="menu-item">
									<a class="menu-link" href="{{route('admin.specialist')}}">
										...
										<span class="menu-title">Appointment Reporty</span>
									</a>
								</div>
								<div class="menu-item">
									<a class="menu-link" href="{{route('admin.monthly.report')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
											<span class="svg-icon svg-icon-2">
												<span class="svg-icon svg-icon-2">
                            ...
                            <div class="menu-item">
                                <div class="menu-content pt-8 pb-2">
                                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">UTILITIES</span>
                                </div>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('admin.specialist') }}">
                                    ...
                                    <span class="menu-title">Specialist Category</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('admin.specialist') }}">
                                    <span class="menu-icon">
                                        ...
                                        <span class="svg-icon svg-icon-2">
                                            <span class="svg-icon svg-icon-2">
                                                <!--transaction setting icon-->
                                                <i class="fas fa-cog"></i>
                                            </span>
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                                    <span class="menu-title">Transaction Configuration</span>
                                </a>
                            </div>
                            <!--END: UTILITIES AREA-->
                        </div>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between"
                        style="background: rgb(0,17,148); background: linear-gradient(262deg, rgba(0,17,148,1) 0%, rgba(28,178,194,1) 100%);">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class=" text-end fw-bolder d-flex align-items-center fs-5 text-white">
                                                {{ Auth::user()->name }}</div>
                                            <div class="text-end text-gray-400 fw-bold fs-7 text-white">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-400px"
                                        data-kt-menu="true">
                                        <!--begin::Menu item-->
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5">
                                                        {{ Auth::user()->name }} <span
                                                            class="badge badge-light-success">{{ Auth::user()->role }}</span>
                                                    </div>
                                                    <a href="#"
