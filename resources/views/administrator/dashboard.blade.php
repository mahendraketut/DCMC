        ...
        <div class="col-xl-12">
            ...
            background: linear-gradient(90deg, rgba(0,17,148,1) 0%, rgba(28,178,194,1) 100%);">
                ...
                <div class="card-body p-0">
                    <!--begin::Chart-->
                    <div class="card-rounded-bottom bg-dark" data-kt-color="danger"
                        style="height: 200px; background: rgb(0,17,148);
                background: linear-gradient(90deg, rgba(0,17,148,1) 0%, rgba(28,178,194,1) 100%);">
                        <h1 class="text-left text-white ms-10">Welcome to the Admin Page<br> {{ Auth::user()->name }}</h1>
                        <a href="{{ route('admin.profile') }}" class="btn btn-white btn-hover-scale me-5 ms-10 mt-5">Manage
                            your profile here</a>
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ route('admin.invoices') }}" class="menu-link px-3">Create Invoice</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        @else
                            <span class="text-muted mt-1 fw-bold fs-7">Today's Queue: {{ $queueCount }}
                                reservation</span>
                        @endif
                    </h3>
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click to add a new appointment">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start flex-column">
                                                <span
                                                    class="text-dark fw-bolder text-hover-primary fs-6">{{ $queue->appointment_id }}</span>
                                                <span
                                                    class="text-muted fw-bold text-muted d-block ">{{ $queue->clinic_type }}</span>
                                            </div>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    @if ($queue->patient->profile_pic)
                                                        <img src="{{ asset('storage/' . $queue->patient->profile_pic) }}"
                                                            alt="image" />
                                                    @else
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary fs-6">{{ $queue->patient->name }}</a>
                                                    <span
                                                        class="text-muted fw-bold text-muted d-block fs-7">{{ $queue->patient->user_id }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
