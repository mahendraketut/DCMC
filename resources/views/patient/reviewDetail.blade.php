            ...
            <div class="card-body p-9">
                ...
                @else
                    <form action="{{ route('patient.review.store') }}" method="POST">
                        ...
                        <div class="row mb-7">
                            <!--begin::Label-->
                            <label class="col-lg-4 fw-semibold text-muted">Rating for
                                {{ $appointment->doctor->name }}</label>
                            <!--end::Label-->
                            ...
                            <div class="col-lg-8">
                                <div class="rate">
                                    <input type="radio" id="star5_for_doctor" class="rate" name="rating_for_doctor"
                                        value="5" {{ old('rating_for_doctor') }} />
                                    <label for="star5_for_doctor" title="text">5 stars</label>
                                    <input type="radio" id="star4_for_doctor" class="rate" name="rating_for_doctor"
                                        value="4" {{ old('rating_for_doctor') }} />
                                    <label for="star4_for_doctor" title="text">4 stars</label>
                                    <input type="radio" id="star3_for_doctor" class="rate" name="rating_for_doctor"
                                        value="3" {{ old('rating_for_doctor') }} />
                                    <label for="star3_for_doctor" title="text">3 stars</label>
                                    <input type="radio" id="star2_for_doctor" class="rate" name="rating_for_doctor"
                                        value="2" {{ old('rating_for_doctor') }} />
                                    <label for="star2_for_doctor" title="text">2 stars</label>
                                    <input type="radio" id="star1_for_doctor" class="rate" name="rating_for_doctor"
                                        value="1" {{ old('rating_for_doctor') }} />
                        ...
                        <div class="row mb-7">
                            <!--begin::Label-->
                            <label class="col-lg-4 fw-semibold text-muted">Feedback for
                                {{ $appointment->doctor->name }}</label>
                            <!--end::Label-->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <diyv class="rate">
                                    ...
                                    <input type="radio" id="star4_for_clinic" class="rate" name="rating_for_clinic"
                                        value="4" />
                                    <label for="star4_for_clinic" title="text">4 stars</label>
                                    <input type="radio" id="star3_for_clinic" class="rate" name="rating_for_clinic"
                                        value="3" />
                                    <label for="star3_for_clinic" title="text">3 stars</label>
                                    <input type="radio" id="star2_for_clinic" class="rate" name="rating_for_clinic"
                                        value="2">
                                    <label for="star2_for_clinic" title="text">2 stars</label>
                                    <input type="radio" id="star1_for_clinic" class="rate" name="rating_for_clinic"
                                        value="1" />
