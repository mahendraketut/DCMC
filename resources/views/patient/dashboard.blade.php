...
@section('content')
            ...
            background: linear-gradient(90deg, rgba(0,17,148,1) 0%, rgba(28,178,194,1) 100%);">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-rounded-bottom bg-dark" data-kt-color="danger"
                        style="height: 300px; background: rgb(0,17,148); background: linear-gradient(90deg, rgba(0,17,148,1) 0%, rgba(28,178,194,1) 100%);">
                        <h1 class="text-left text-center text-white ms-10">
                            <div class="symbol symbol-100px symbol-circle mb-7">
                                @if (Auth::user()->profile_pic)
                                    <img src="{{ asset('storage/' . Auth::user()->profile_pic) }}" alt="image" />
                                @else
                                    <img src="{{ asset('admin/assets/media/avatars/blank.png') }}" class="card-img-top"
                                        alt="image" />
                                @endif
                            </div>
                            <br>
                            ...
                            <a href="{{ route('patient.profile') }}"
                                class="btn btn-white btn-hover-scale me-5 ms-10 mt-5">Manage your profile here</a>
                        </h1>
                    </div>
                    <!--end::Chart-->
                    <!--begin::Stats-->
    ...
    <div class="py-5">
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="{{ route('patient.payment') }}" class="card hover-elevate-up shadow-sm parent-hover">
                    <div class="card-body d-flex align-items">
                        ...
                        <div class="row g-0">
                            <div class="col">
                                @if ($schedule->user->profile_pic)
                                    <img src="{{ asset('storage/' . $schedule->user->profile_pic) }}"
                            ...
                            <div class="col-md-11">
                                <div class="card-body d-flex align-items-center justify-content-between"
                                    style="padding: 2%">
                                    <div>
                                        <h4 class="card-title">{{ $schedule->user->name }} |
                                            {{ $schedule->user->specialist->name }}</h4>
                                        <p class="card-text">{{ $schedule->day }}, {{ $schedule->start_time }} -
                                            {{ $schedule->end_time }}</p>
                                    </div>
