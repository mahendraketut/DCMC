                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('patient.dashboard') }}"
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('patient.view.doctor') }}">
                                    ...
                                    <span class="menu-title">Find Doctor</span>
                                </a>
                            </div>
                            <div class="menu-item">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('patient.view.prescription') }}">
                                    <span class="menu-icon">
                                        <!--icon medicine-->
                                        <span class="svg-icon svg-icon-2">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('patient.payment') }}">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('patient.review') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <!--icon review and feedback-->
                                            <i class="fas fa-comment-medical"></i>
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                                    <span class="menu-title">Review and Feedback</span>
                                </a>
                            </div>
                        </div>
                        <!--end::Menu-->
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between"
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="{{ route('patient.dashboard') }}" class="d-lg-none">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-400px"
                                        ...
                                        <div class="menu-item px-5">
                                            <a href="{{ route('patient.profile') }}" class="menu-link px-5">My
                                                Profile</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">@yield('title')
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Description-->
                                    <span class="text-muted fs-7 fw-bold">Patient</span>
                                    <!--end::Description-->
                                </h1>
                                <!--end::Title-->
                            </div>
