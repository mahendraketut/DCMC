    ...
    <div class="card card-xl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Prescriptiont Lists</span>
            </h3>
        </div>
                    ...
                    <tbody>
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td class="ps-4 min-w-50px text-center">{{$prescription->status}}</td>
                                <td class="ps-4 min-w-20px text-center">
                                    <a href="{{url('/patient.view.prescription.detail/'.$prescription->id)}}" class="btn btn-primary">View Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        @endif
